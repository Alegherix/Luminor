...
export const MICROPHONE_USAGE_DESCRIPTION =
  "Luminor needs microphone access so you can record voice notes and transcribe them into the chat composer.";
...
export const MAC_APPSNAP_HELPER_STAGE_PATH =
  "apps/desktop/native/appsnap/build/luminor-appsnap-helper";
export const MAC_APPSNAP_HELPER_ASAR_EXCLUSION = "!apps/desktop/native/appsnap/build/**";
export const MAC_APPSNAP_HELPER_BUNDLE_PATH = "Contents/Helpers/luminor-appsnap-helper";
...
export function createDesktopPlatformBuildConfig(
  ...
  const nativePackaging = {
    asarUnpack: [...DESKTOP_NATIVE_ASAR_UNPACK_GLOBS],
    extraFiles: [{ from: THIRD_PARTY_NOTICES_PATH, to: THIRD_PARTY_NOTICES_PATH }],
  };

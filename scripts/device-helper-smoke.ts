...
import { decodeDeviceFrame } from "@luminor/shared/deviceFrame";
import {
  DEVICE_HELPER_CACHE_SEGMENTS,
  deviceHelperCacheKey,
  readDeviceHelperSourceRevision,
} from "@luminor/shared/deviceHelperCache";
...
async function main(): Promise<void> {
  ...
  // comes from @luminor/shared so this build lands in the same directory the

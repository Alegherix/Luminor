...
const sourcemapEnv = process.env.LUMINOR_DESKTOP_SOURCEMAP?.trim().toLowerCase();
...
export default defineConfig([
  {
    ...
    define: {
      __LUMINOR_WINDOWS_UPDATER_PUBLISHER__: JSON.stringify(windowsUpdaterPublisher),
    },
    noExternal: (id) => id.startsWith("@luminor/"),
  },
  {
    ...shared,
  ...
  {
    ...shared,
    entry: ["src/offscreenGuestPreload.ts", "src/browserFrame/jpegWorker.ts"],
  },
]);

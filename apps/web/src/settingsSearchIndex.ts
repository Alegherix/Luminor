...
export const SETTINGS_SEARCH_ENTRIES: readonly SettingsSearchEntry[] = [
  ...
  },
  {
    ...
    keywords: "Use the operating system interface font throughout Luminor.",
  },
  {
  ...
  // ── Keybindings ───────────────────────────────────────────────────────────────
  {
    ...
    title: "Keybindings",
    keywords:
      "Every keyboard shortcut available in Luminor, grouped by context. keybindings hotkeys key combo cmd ctrl reference",
    target: null,
  },
  ...
  // ── Worktrees ─────────────────────────────────────────────────────────────────
  {
    ...
    keywords: "Review and clean up the worktrees created by Luminor. git branch remove",
    target: null,
  },
  ...
  },
  {
    ...
    keywords: "Update installed provider tools that Luminor can safely update. upgrade cli",
  },
  {

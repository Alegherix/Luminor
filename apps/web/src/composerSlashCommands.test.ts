...
import { THREAD_GOAL_MAX_CHARS } from "@luminor/contracts";
...
describe("composerSlashCommands", () => {
  ...
  it("keeps Feedback Luminor ahead of provider-native /feedback", () => {
    const availableCommands = getAvailableComposerSlashCommands({
  ...
  it("only exposes Luminor-owned app commands for claude", () => {

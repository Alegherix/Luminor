...
import type { ProviderKind, ServerProviderStatus, ServerSettings } from "@luminor/contracts";
...
describe("getVisibleProviderUpdateStatuses", () => {
  it("excludes providers hidden from Luminor so unchecked providers do not nag", () => {
...
describe("shouldPromptProviderUpdate", () => {
  // Cursor and Antigravity self-update, so Luminor has no registry to read a latest
  ...
  it("keeps prompting for providers Luminor can prove are behind", () => {

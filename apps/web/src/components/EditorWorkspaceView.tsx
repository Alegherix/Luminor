...
const EDITOR_CHAT_PANE_STORAGE_KEY = "luminor.editor.chatPaneWidth";
const EDITOR_SIDEBAR_VISIBLE_STORAGE_KEY = "luminor.editor.sidebarVisible";
const EDITOR_CHAT_PANE_VISIBLE_STORAGE_KEY = "luminor.editor.chatPaneVisible";

...
import type { GitBranch, GitStashInfoResult, GitStatusResult, NativeApi } from "@luminor/contracts";
            ...
            try {
              ...
              if (isStashConflictError(stashError)) {
                ...
                addBranchRecoveryToast({
                  ...
                  description:
                    "Luminor switched branches and kept your changes in a stash because they could not be restored onto this branch cleanly.",

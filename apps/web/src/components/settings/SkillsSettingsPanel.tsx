...
// catalog (~/.luminor/skills plus each provider's skills folder), shows which provider
...
import type { ProviderKind, ServerSettings } from "@luminor/contracts";
...
export function SkillsSettingsPanel() {
  ...
  const luminorSkillsDir = catalogQuery.data?.luminorSkillsDir;

  return (
    <div className="space-y-8">
      <SettingsSection title="Portable skills">
        <SettingsRow
          title="Luminor skills folder"
      ...
      {catalogQuery.isError ? (
        <SettingsSection title="Skills">
          <SettingsRow
            ...
            description="Luminor could not scan the skill folders. Retry after checking that the server is running."
          />
        </SettingsSection>
      ) : null}
      ...
      {!catalogQuery.isLoading && !catalogQuery.isError && totalSkills === 0 ? (
        <SettingsSection title="Skills">
          <SettingsRow
            ...
            description="Add a skill folder containing a SKILL.md to the Luminor skills folder above, or install skills for any supported provider."
          />
        </SettingsSection>
      ) : null}

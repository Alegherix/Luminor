...
import type { ProfileStats, ProfileTokenStats } from "@luminor/contracts";
import { ProviderIcon } from "~/components/ProviderIcon";
import { LuminorLogo } from "~/components/LuminorLogo";
    ...
    >
      ...
      <div className="flex min-w-0 items-center justify-between gap-6">
        ...
        <div className="flex shrink-0 items-center gap-2 text-slate-600">
          <LuminorLogo className="size-6 text-slate-700" />
          <span className="text-xl font-normal tracking-tight">Luminor</span>
        </div>
      </div>

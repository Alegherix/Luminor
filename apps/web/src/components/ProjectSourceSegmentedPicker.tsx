...
/**
 * The compact raised-thumb picker previously used for the Luminor/Studio switch,
        ...
        {PROJECT_SOURCES.map((source, index) => {
          ...
          return (
            <button
              ...
              title={
                sourceUnavailable ? "Update the Luminor server to add GitHub projects." : undefined
              }
              className={cn(

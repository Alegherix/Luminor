...
// A provider whose latest version Luminor cannot look up (self-updating CLIs such as
...
// Header affordance: reserved for providers Luminor can actually assert are outdated.

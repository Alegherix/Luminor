...
// Layer: Web UI state
// Why: "Void" is Luminor's word for "not filed yet", and it is the one Space label a user
...
import { SPACE_NAME_MAX_LENGTH } from "@luminor/contracts";
...
const STORAGE_KEY = "luminor:void-space:v1";

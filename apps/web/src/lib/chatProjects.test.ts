...
import { ProjectId, type OrchestrationShellSnapshot } from "@luminor/contracts";
...
describe("isHomeChatContainerProject", () => {
  it("matches the managed Documents/Luminor general-chat root used by older drafts", () => {
    expect(
      isHomeChatContainerProject(
        {
          cwd: "/Users/tester/Documents/Luminor",
          kind: "chat",
          name: "Home",
          remoteName: "Home",
        },
  ...
  it("matches Codex-style date/slug chat workspaces under Documents/Luminor", () => {
    expect(
      isHomeChatContainerProject(
        {
          cwd: "/Users/tester/Documents/Luminor/2026-06-11/yes-it-takes-all-the-skills",
          kind: "chat",
          name: "Yes it takes",
  ...
  it("trusts the chat kind before any server workspace path resolves", () => {
    ...
    expect(
      isHomeChatContainerProject(
        {
          cwd: "/Users/tester/Documents/Luminor/2026-06-11/some-chat",
          kind: "chat",
          name: "Some chat",
  ...
  it("does not classify ordinary projects under Documents/Luminor as home chat containers", () => {
    expect(
      isHomeChatContainerProject(
        {
          cwd: "/Users/tester/Documents/Luminor",

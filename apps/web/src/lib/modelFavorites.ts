...
export const FAVORITE_MODEL_STORAGE_KEYS = {
  cursor: "luminor:cursor-favourite-models:v1",
  kilo: "luminor:kilo-favourite-models:v1",
  opencode: "luminor:opencode-favourite-models:v1",
  pi: "luminor:pi-favourite-models:v1",
} as const;

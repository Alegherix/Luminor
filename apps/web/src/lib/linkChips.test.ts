...
describe("parseBareComposerLink", () => {
  it("returns the URL when the whole text is one bare link", () => {
    expect(parseBareComposerLink("https://github.com/Emanuele-web04/luminor")).toBe(
      "https://github.com/Emanuele-web04/luminor",
    );
  });
...
describe("describeLinkChip", () => {
  it("shortens GitHub pull request URLs to owner/repo#number", () => {
    expect(describeLinkChip("https://github.com/Emanuele-web04/luminor/pull/155")).toEqual({
      label: "Emanuele-web04/luminor#155",
      isGitHub: true,
    });
  });

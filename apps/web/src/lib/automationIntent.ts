...
// Purpose: Detects when a normal chat prompt is actually asking Luminor to create an automation.
...
import { completionPolicyFromStopWhen } from "@luminor/shared/automationCompletionPolicy";

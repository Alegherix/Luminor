import type { ProviderKind, ProviderModelDescriptor } from "@luminor/contracts";
import { getModelCapabilities, hasEffortLevel, trimOrNull } from "@luminor/shared/model";

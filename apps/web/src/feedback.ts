...
// Depends on: The public tryluminor feedback endpoint.
...
export const FEEDBACK_CATEGORIES = [
  ...
  { value: "performance", label: "Performance", lead: "Luminor felt slow" },
...
const DEFAULT_FEEDBACK_ENDPOINT = "https://www.tryluminor.com/api/feedback";
...
export function formatFeedbackSummary(input: {
  ...
  return [`${lead} in Luminor ${diagnostics.appVersion}${usageContext}.`, "", ...detailLines].join(
    "\n",
  );
}

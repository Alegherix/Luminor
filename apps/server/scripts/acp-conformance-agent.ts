...
const logPath = process.env.LUMINOR_ACP_CONFORMANCE_LOG_PATH;
const malformedPrefix = process.env.LUMINOR_ACP_CONFORMANCE_MALFORMED_PREFIX === "1";
...
const app = agent({ name: "luminor-official-sdk-conformance-agent" })

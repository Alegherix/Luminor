...
import { isSupportedLocalImagePath as isSupportedLocalImagePathShared } from "@luminor/shared/localPreviewFiles";
 ...
 * writes images under for the current process env. Luminor uses its isolated
 ...
 * overlay `<LUMINOR_HOME>/codex-home-overlay/generated_images` so we serve

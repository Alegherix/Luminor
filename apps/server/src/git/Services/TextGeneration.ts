...
export class CodexTextGeneration extends ServiceMap.Service<
  CodexTextGeneration,
  TextGenerationShape
>()("luminor/git/Services/TextGeneration/CodexTextGeneration") {}
...
export class OpenCodeTextGeneration extends ServiceMap.Service<
  ...
  TextGenerationShape
>()("luminor/git/Services/TextGeneration/OpenCodeTextGeneration") {}
...
export class KiloTextGeneration extends ServiceMap.Service<
  KiloTextGeneration,
  TextGenerationShape
>()("luminor/git/Services/TextGeneration/KiloTextGeneration") {}

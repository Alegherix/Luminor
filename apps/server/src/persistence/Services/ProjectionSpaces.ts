...
import { IsoDateTime, NonNegativeInt, SpaceIconName, SpaceId, SpaceName } from "@luminor/contracts";
...
>()("luminor/persistence/Services/ProjectionSpaces/ProjectionSpaceRepository") {}

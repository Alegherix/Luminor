 ...
 * names. Because the migrator skips by ID, Luminor migrations 17-31 never run
 ...
 * Luminor migrations known at the time, but predecessor trackers eventually
 ...
 *
 * Idempotent and a no-op for fresh Luminor installs (every column already

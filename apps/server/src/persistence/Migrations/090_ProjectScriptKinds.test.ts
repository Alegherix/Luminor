...
it.effect("090_ProjectScriptKinds migrates persisted script roles", () =>
  Effect.gen(function* () {
    ...
    assert.deepStrictEqual(yield* runMigrations({ toMigrationInclusive: 90 }), [
      [90, "ProjectScriptKinds"],
    ]);

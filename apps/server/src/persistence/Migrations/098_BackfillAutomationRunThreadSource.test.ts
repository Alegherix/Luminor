...
describe("098_BackfillAutomationRunThreadSource", () => {
    ...
    Effect.gen(function* () {
      ...
      yield* sql`
        INSERT INTO orchestration_events (
          ...
          (
            ...
            ${`{"threadId":"${normalThreadId}","title":"Normal","creationSource":"luminor_mcp"}`}, '{}'
          )
      `;
      ...
      assert.deepStrictEqual(
        ...
        [
          ...
          { eventId: "event-normal", creationSource: "luminor_mcp" },

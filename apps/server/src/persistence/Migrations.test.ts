  ...
  it.effect("keeps a private database that already recorded old migration 54 compatible", () =>
    Effect.gen(function* () {
      ...
      assert.deepStrictEqual(executed, [
        ...
        [89, "MobileAuthAudienceAndPairingDigests"],
        [90, "ThreadCreationOperations"],
      ]);
      ...
      assert.deepStrictEqual(tracker.slice(-37), [
        ...
        { migration_id: 89, name: "MobileAuthAudienceAndPairingDigests" },
        { migration_id: 90, name: "ThreadCreationOperations" },
      ]);

...
import { EDITOR_ICON_ROUTE_PATH } from "@luminor/shared/editorIcons";
        ...
        return HttpServerResponse.jsonUnsafe(
          { error: authorization.reason === "unavailable" ? "Not Found" : "Unauthorized" },
          {
            ...
            ...(authorization.status === 401
              ? { headers: { "WWW-Authenticate": 'Bearer realm="luminor-desktop-shutdown"' } }
              : {}),
          },
        );
      }
...
const threadExportEffectRouteLayer = HttpRouter.add(
  ...
  Effect.gen(function* () {
    ...
    // app fetches cross-origin (luminor://app), and without them the browser masks

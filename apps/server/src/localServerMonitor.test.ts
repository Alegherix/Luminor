...
describe("localServerMonitor", () => {
  ...
  it("keeps dev servers and ignores Electron/Luminor-style application listeners", () => {
    expect(
      isLikelyDevServerProcess({
        command: "node",
    ...
    expect(
      isIgnoredLocalServerProcess({
        command: "Electron",
        args: "/Applications/Luminor.app/Contents/MacOS/Luminor",
        ports: [61449],
      }),
    ).toBe(true);
    expect(
    ...
    expect(
      isLikelyDevServerProcess({
        command: "node",
        args: "node /Users/emanueledipietro/Developer/luminor/apps/web/node_modules/.bin/vite",
        ports: [5733],
      }),
    ).toBe(true);
    expect(
    ...
    const processInfo = new Map<number, LocalServerProcessInfo>([
      ...
      [
        12094,
        {
          ppid: 12064,
          commandLine:
            "node /Users/emanueledipietro/Developer/luminor-website/node_modules/.bin/next dev",
        },
      ],
      [
        12064,

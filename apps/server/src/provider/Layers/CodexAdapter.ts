...
import { luminorSkillsDir } from "../skillsCatalog.ts";
...
// Generous by design; override with LUMINOR_CODEX_TURN_IDLE_TIMEOUT_MS.
const CODEX_TURN_IDLE_TIMEOUT_MS = resolveAcpTurnIdleTimeoutMs({
  envVar: "LUMINOR_CODEX_TURN_IDLE_TIMEOUT_MS",
  defaultMs: 900_000,
});
      ...
      Effect.gen(function* () {
        ...
        return (
          ...
          new CodexAppServerManager(services, {
            luminorSkillsDir: luminorSkillsDir(serverConfig.baseDir),

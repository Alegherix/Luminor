...
export const takeCursorLuminorHarnessPolicyTextPart = (
...
// forever. Generous by design; override with LUMINOR_CURSOR_TURN_IDLE_TIMEOUT_MS.
const CURSOR_TURN_IDLE_TIMEOUT_MS = resolveAcpTurnIdleTimeoutMs({
  envVar: "LUMINOR_CURSOR_TURN_IDLE_TIMEOUT_MS",
  defaultMs: 600_000,
});
...
const CURSOR_PLAN_MODE_PROMPT_PREFIX = [
  "Luminor Cursor plan mode is active.",
  ...
  return Effect.gen(function* () {
    ...
    const sendTurn: CursorAdapterShape["sendTurn"] = (input) =>
      Effect.gen(function* () {
        ...
        const harnessPolicy = takeCursorLuminorHarnessPolicyTextPart(
          ctx,

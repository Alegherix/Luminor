...
import type { ChatAttachment, ProviderKind, ThreadId } from "@luminor/contracts";
...
const PROVIDER_ATTACHMENT_STORAGE_PATH = Symbol("luminor.providerAttachmentStoragePath");

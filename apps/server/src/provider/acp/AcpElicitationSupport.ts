...
// Purpose: Bridges ACP form elicitation schemas to Luminor's provider-neutral question UI.
...
// Converts primitive ACP form fields into the question shape consumed by Luminor's composer.

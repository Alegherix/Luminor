...
export interface AcpSessionRuntimeOptions {
   ...
   * `mcpCapabilities` (e.g. HTTP vs stdio for the Luminor agent gateway).
   */
...
/**
 * Bridges Effect's child-process exit signal into Luminor's process-tree proof. This is deliberately
...
>()("luminor/provider/acp/AcpSessionRuntime") {
  static layer(

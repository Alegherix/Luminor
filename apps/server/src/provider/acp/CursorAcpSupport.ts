 ...
 */
import { type CursorModelOptions, type ProviderModelDescriptor } from "@luminor/contracts";
import { formatModelDisplayName, parseCursorCliReasoningEffort } from "@luminor/shared/model";
...
// Cursor exposes "auto" as a `default` model id over ACP; keep Luminor's "auto"

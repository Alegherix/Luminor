import type { ProviderUserInputAnswers, UserInputQuestion } from "@luminor/contracts";
...
const LUMINOR_PLAN_REVIEW_FEEDBACK =
...
/**
 * Luminor owns the approval step after the planning turn settles. Returning a
...
export function makeGrokExitPlanModeCapturedResponse(): {
  ...
  return {
    outcome: "cancelled",
    feedback: LUMINOR_PLAN_REVIEW_FEEDBACK,
  };
}

/** Luminor has already received an implementation turn, so Grok may leave its native gate. */

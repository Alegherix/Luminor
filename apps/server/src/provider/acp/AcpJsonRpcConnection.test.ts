  ...
  it.effect("forwards provider session metadata when creating a session", () => {
    ...
    return Effect.gen(function* () {
      ...
      expect(sessionStarted?.payload).toMatchObject({
        _meta: {
          "x.ai/hooks": {
            PreToolUse: [{ matcher: "*", hookCallbackIds: ["luminor-plan-guard"] }],
          },
        },
      });
    }).pipe(
      ...
      Effect.provide(
        AcpSessionRuntime.layer({
          spawn: {
            command: bunExe,
            args: [mockAgentPath],
            env: { VITEST: "true", LUMINOR_ACP_SUPPORT_SESSION_RESUME: "1" },
          },
          cwd: process.cwd(),
          resumeSessionId: "mock-session-1",
          sessionMeta: { reconnectPolicy: "keep-hooks" },
      ...
      Effect.provide(
        AcpSessionRuntime.layer({
          spawn: {
            command: bunExe,
            args: [mockAgentPath],
            env: { VITEST: "true", LUMINOR_ACP_SUPPORT_SESSION_LOAD: "0" },
          },
          cwd: process.cwd(),
          resumeSessionId: "mock-session-1",
          clientInfo: { name: "luminor-test", version: "0.0.0" },
        ...
        AcpSessionRuntime.layer({
          spawn: {
            ...
            env: {
              ...
              LUMINOR_ACP_EMIT_AVAILABLE_COMMANDS: "1",
              LUMINOR_ACP_MODE_CONFIG_ID: "autonomy_level",
            },
          },
          cwd: process.cwd(),
      ...
      Effect.provide(
        AcpSessionRuntime.layer({
          spawn: {
            ...
            env: {
              VITEST: "true",
              LUMINOR_ACP_EMIT_INTERLEAVED_ASSISTANT_TOOL_CALLS: "1",
            },
          },
          cwd: process.cwd(),
          clientInfo: { name: "luminor-test", version: "0.0.0" },
      ...
      Effect.provide(
        AcpSessionRuntime.layer({
          spawn: {
            ...
            env: {
              VITEST: "true",
              LUMINOR_ACP_EMIT_UPSTREAM_ASSISTANT_MESSAGE_IDS: "1",
            },
          },
          cwd: process.cwd(),
          clientInfo: { name: "luminor-test", version: "0.0.0" },
      ...
      Effect.provide(
        AcpSessionRuntime.layer({
          spawn: {
            ...
            env: {
              VITEST: "true",
              LUMINOR_ACP_EMIT_GENERIC_TOOL_PLACEHOLDERS: "1",
            },
          },
          cwd: process.cwd(),
          clientInfo: { name: "luminor-test", version: "0.0.0" },
      ...
      Effect.provide(
        AcpSessionRuntime.layer({
          spawn: {
            ...
            env: {
              VITEST: "true",
              LUMINOR_ACP_EMIT_REASONING_THEN_TOOL_CALL: "1",
            },
          },
          cwd: process.cwd(),
          clientInfo: { name: "luminor-test", version: "0.0.0" },

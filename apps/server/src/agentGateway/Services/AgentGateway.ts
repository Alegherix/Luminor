/**
 * AgentGateway - Luminor app-control tool surface for provider agents.
 *
 * Serves the `luminor_*` MCP tools that let any provider session (Codex,
 * Claude, Grok, ...) inspect and control Luminor itself: list projects and
...
export class AgentGateway extends ServiceMap.Service<AgentGateway, AgentGatewayShape>()(
  "luminor/agentGateway/Services/AgentGateway",
) {}

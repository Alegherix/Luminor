/**
 * AgentGatewayCredentials - Per-session credentials for the Luminor agent
 * gateway.
 *
...
export interface AgentGatewayCredentialsShape {
  /** Streamable-HTTP MCP endpoint served by this Luminor instance. */
...
>()("luminor/agentGateway/Services/AgentGatewayCredentials") {}

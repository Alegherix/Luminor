...
const USAGE = "Usage: luminor-restore-migration-backup <absolute-database-path>";
const STOP_PROCESSES_WARNING =
  "WARNING: Stop every Luminor process before restoring a migration backup.";
...
const entryPointNames = new Set([
  ...
  "luminor-restore-migration-backup",
]);

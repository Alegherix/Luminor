...
const BaseTestLayer = makeProjectionPipelinePrefixedTestLayer("luminor-projection-pipeline-test-");
...
it.layer(Layer.fresh(makeProjectionPipelinePrefixedTestLayer("luminor-message-identity-scope-")))(
  "OrchestrationProjectionPipeline",
  (it) => {
...
it.layer(Layer.fresh(makeProjectionPipelinePrefixedTestLayer("luminor-text-segment-scope-")))(
  "OrchestrationProjectionPipeline",
  (it) => {
    it.effect(
...
it.layer(Layer.fresh(makeProjectionPipelinePrefixedTestLayer("luminor-approval-identity-scope-")))(
  "OrchestrationProjectionPipeline",
  (it) => {
    ...
    Effect.provide(
      Layer.provideMerge(
        ServerConfig.layerTest(process.cwd(), {
          prefix: "luminor-projection-pipeline-fast-forward-",
        }),
        NodeServices.layer,
      ),
    ),
...
it.effect("drains 2,501 file-backed events to a captured high-water fence", () =>
  Effect.gen(function* () {
    ...
    Effect.provide(
      Layer.provideMerge(
        ServerConfig.layerTest(process.cwd(), {
          prefix: "luminor-projection-pipeline-paged-",
        }),
        NodeServices.layer,
      ),
    ),
...
it.layer(Layer.fresh(makeProjectionPipelinePrefixedTestLayer("luminor-base-")))(
  "OrchestrationProjectionPipeline",
  (it) => {
...
it.layer(
  Layer.fresh(makeProjectionPipelinePrefixedTestLayer("luminor-projection-pipeline-approvals-")),
...
it.layer(
  Layer.fresh(makeProjectionPipelinePrefixedTestLayer("luminor-projection-attachments-safe-")),
)("OrchestrationProjectionPipeline", (it) => {
...
it.layer(
  Layer.fresh(makeProjectionPipelinePrefixedTestLayer("luminor-projection-attachments-overwrite-")),
)("OrchestrationProjectionPipeline", (it) => {
...
it.layer(
  Layer.fresh(makeProjectionPipelinePrefixedTestLayer("luminor-projection-attachments-rollback-")),
)("OrchestrationProjectionPipeline", (it) => {
...
it.layer(
  Layer.fresh(makeProjectionPipelinePrefixedTestLayer("luminor-projection-attachments-revert-")),
)("OrchestrationProjectionPipeline", (it) => {
...
it.layer(
  Layer.fresh(makeProjectionPipelinePrefixedTestLayer("luminor-projection-attachments-delete-")),
)("OrchestrationProjectionPipeline", (it) => {
...
it.effect("restores pending turn-start metadata across projection pipeline restart", () =>
  Effect.gen(function* () {
    ...
    Effect.provide(
      Layer.provideMerge(
        ServerConfig.layerTest(process.cwd(), {
          prefix: "luminor-projection-pipeline-restart-",
        }),
        NodeServices.layer,
      ),
    ),
...
const engineLayer = it.layer(
  OrchestrationEngineLive.pipe(
    ...
    Layer.provideMerge(
      ServerConfig.layerTest(process.cwd(), {
        prefix: "luminor-projection-pipeline-engine-dispatch-",
      }),
    ),
    Layer.provideMerge(NodeServices.layer),
  ),
  ...
  it.effect("projects persist updated scripts from project.meta.update", () =>
    Effect.gen(function* () {
      ...
      assert.deepEqual(projectRows, [
        {
          scriptsJson:
            '[{"id":"script-1","name":"Build","command":"bun run build","icon":"build","kind":"manual"}]',
...
it.layer(
  Layer.fresh(makeProjectionPipelinePrefixedTestLayer("luminor-projection-pipeline-turn-finish-")),
)("OrchestrationProjectionPipeline", (it) => {

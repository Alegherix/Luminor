...
// Purpose: Normalizes provider-native transcript snapshots into Luminor import messages.
...
import { MessageId, type ThreadHandoffImportedMessage, type ThreadId } from "@luminor/contracts";

...
import { CommandId, ProjectId, SpaceId, type OrchestrationCommand } from "@luminor/contracts";
...
describe("Spaces", () => {
  ...
  it("rejects filing a legacy Home chat container into a space", async () => {
    ...
    const workspacePaths = {
      homeDir: "/Users/dev",
      chatWorkspaceRoot: "/Users/dev/Documents/Luminor/Chats",
    };
    let readModel = createEmptyReadModel(createdAt);
    ...
    ({ readModel } = await dispatch(readModel, {
      ...
      title: "Luminor",
      workspaceRoot: "/Users/dev/code/luminor",
      createdAt,
    }));

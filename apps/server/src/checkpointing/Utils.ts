...
import { resolveThreadWorkspaceCwd as resolveSharedThreadWorkspaceCwd } from "@luminor/shared/threadEnvironment";

export const CHECKPOINT_REFS_PREFIX = "refs/luminor/checkpoints";

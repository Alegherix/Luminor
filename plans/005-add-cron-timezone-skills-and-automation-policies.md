...
Codex docs recommend combining automations with skills using `$skill-name`. Make Luminor's draft UI and parser preserve skill references in prompt text and optionally surface selected skills if existing composer skill selection can be persisted.

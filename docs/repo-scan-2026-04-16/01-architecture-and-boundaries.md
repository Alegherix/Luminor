...
- [`apps/server/src/orchestration`](/Users/emanueledipietro/Developer/Testing/luminor/apps/server/src/orchestration)
- [`apps/server/src/provider`](/Users/emanueledipietro/Developer/Testing/luminor/apps/server/src/provider)
- [`apps/server/src/persistence`](/Users/emanueledipietro/Developer/Testing/luminor/apps/server/src/persistence)
...
[`packages/contracts/src/orchestration.ts`](/Users/emanueledipietro/Developer/Testing/luminor/packages/contracts/src/orchestration.ts) is large enough that future protocol churn could become noisy and hard to review.

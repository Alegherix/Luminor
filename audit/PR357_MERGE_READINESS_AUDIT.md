# Luminor PR #357 — Final code-quality, ACP, and provider audit

**Audit date:** 2026-07-15
**PR:** [#357 — Audit and harden code quality across desktop and server paths](https://github.com/Emanuele-web04/luminor/pull/357)
...
- after all tests, direct children of the Luminor server totalled about 1.84 GiB RSS, dominated by
  OpenCode;
...
as the sole protocol/wire authority and keep Effect above it as Luminor's lifecycle and application
...
- `AcpSessionRuntime.ts` constructs `OfficialAcp.client({ name: "luminor" })`, registers client
...
client/agent builders, handlers, streams, validation, and connection lifecycle that Luminor would
...
- Closing the browser reduced the retained process from roughly 651 MiB to 135 MiB; stopping Luminor
...
- [ ] Do not recreate official SDK types in a new Luminor package.

...
// the shareable activity card. All metrics are backed by Luminor's local DB
...
export const ProfileActivity = Schema.Struct({
  ...
  // totalPromptsSent), i.e. days the user actually used Luminor.
...
// Token totals come from Luminor's projected context-window updates. `available`

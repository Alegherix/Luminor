...
import {
  LuminorCapabilitiesResult,
  LuminorCreateThreadsInput,
  LuminorCreateThreadsResult,
  LuminorGatewayErrorResult,
  LuminorWaitForThreadsInput,
  LuminorWaitForThreadsResult,
} from "./agentGateway";

const decodeCreate = Schema.decodeUnknownSync(LuminorCreateThreadsInput);
const decodeWait = Schema.decodeUnknownSync(LuminorWaitForThreadsInput);
...
describe("agent gateway contracts", () => {
  ...
  it("decodes typed capability, creation, wait, and error results", () => {
    assert.doesNotThrow(() =>
      Schema.decodeUnknownSync(LuminorCapabilitiesResult)({
        targetConstruction: {
          codex: {
    ...
    assert.doesNotThrow(() =>
      Schema.decodeUnknownSync(LuminorCreateThreadsResult)({
    ...
    assert.doesNotThrow(() =>
      Schema.decodeUnknownSync(LuminorWaitForThreadsResult)({
    ...
    assert.doesNotThrow(() =>
      Schema.decodeUnknownSync(LuminorGatewayErrorResult)({

...
// Unified cross-provider skills catalog (Luminor portable skills). Descriptors use
// `scope` to carry the origin label ("luminor", "codex", "claude", "cursor", ...).
...
export const ProviderSkillsCatalogResult = Schema.Struct({
  skills: Schema.Array(ProviderSkillDescriptor),
  luminorSkillsDir: Schema.optional(TrimmedNonEmptyString),
});

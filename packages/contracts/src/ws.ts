...
export const WS_METHODS = {
  ...
  pullRequestsMarkInboxViewed: "pullRequests.markInboxViewed",
  pullRequestsMarkInboxNotified: "pullRequests.markInboxNotified",
  ...
  serverListResourceProcesses: "server.listResourceProcesses",
  serverStopResourceProcess: "server.stopResourceProcess",
  serverStopResourceLeftovers: "server.stopResourceLeftovers",
...
const WebSocketRequestBody = Schema.Union([
  ...
  tagRequestBody(WS_METHODS.pullRequestsInbox, PullRequestInboxInput),
  tagRequestBody(WS_METHODS.pullRequestsMarkInboxViewed, PullRequestInboxMarkViewedInput),
  tagRequestBody(WS_METHODS.pullRequestsMarkInboxNotified, PullRequestInboxMarkNotifiedInput),
  ...
  tagRequestBody(WS_METHODS.serverListResourceProcesses, Schema.Struct({})),
  tagRequestBody(WS_METHODS.serverStopResourceProcess, ServerStopResourceProcessInput),
  tagRequestBody(WS_METHODS.serverStopResourceLeftovers, Schema.Struct({})),

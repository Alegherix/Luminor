...
const BROWSER_COMMON_AGENT_GUIDANCE =
  "Controls only this thread's shared Luminor browser runtime (same DOM, cookies and session), never chat or desktop. It may continue in the background when another chat is active; no approval prompt is required.";

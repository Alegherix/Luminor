...
const PATH_CAPTURE_START = "__LUMINOR_PATH_START__";
const PATH_CAPTURE_END = "__LUMINOR_PATH_END__";
 ...
 */
export const SHELL_ENVIRONMENT_HYDRATED_ENV_NAME = "LUMINOR_PATH_HYDRATED";
...
function envCaptureStart(name: string): string {
  return `__LUMINOR_ENV_${name}_START__`;
}

function envCaptureEnd(name: string): string {
  return `__LUMINOR_ENV_${name}_END__`;
}

...
const PATHS = {
  homeDir: "/Users/demo",
  chatWorkspaceRoot: "/Users/demo/Documents/Luminor",
};

describe("resolveChatContainerWorkspaceRoot", () => {
  it("prefers the configured chat root and falls back to the home directory", () => {
    expect(resolveChatContainerWorkspaceRoot(PATHS)).toBe("/Users/demo/Documents/Luminor");
...
describe("matchesLegacyHomeChatWorkspaceRoot", () => {
  it("matches the chat root and the home directory, tolerating trailing slashes", () => {
    expect(matchesLegacyHomeChatWorkspaceRoot("/Users/demo/Documents/Luminor/", PATHS)).toBe(true);
